...
exports.deleteAccounts = exports.getPortfolioImages = exports.getUserImages = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const database_1 = require("./database");
const helper_1 = require("./helper");
const users_1 = __importDefault(require("./modules/users"));
const imageFormats = ["jpeg", "jpg", "webp", "JPG", "png"];
const getUserImages = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    users = users.filter((a) => !a.image.includes("scontent"));
    let errorImages = [];
    // reUploadImage(
    //   {
    ...
    for (let index = 0; index < users.length; index++) {
        ...
        const ext = splittedImage[splittedImage.length - 1];
        // console.log(extension)
        let folder = "profilePIC";
        (0, helper_1.reUploadImage)({
            imgUrl: image, _id, ext, folder
        }).then((reUploadedPic) => __awaiter(void 0, void 0, void 0, function* () {
            console.log(typeof (reUploadedPic));
            if (typeof (reUploadedPic) == 'string' && reUploadedPic.startsWith("https://")) {
                const updatedProfPic = yield (0, database_1.update)({
                    table: "Users",
                    qty: "updateOne",
                    query: {
                        _id, //_id:_id
...
const getPortfolioImages = () => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    let accounts = [
    ...
    let userIds = users.map((a) => a._id.toString());
